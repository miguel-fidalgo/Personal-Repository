...
class ParserTest extends TimedSuite {
  ...
  test("MultipleAddopAdd") {
    ...
    testMultipleAdd("4-2", Minus(Lit(4), Lit(2)))
  ...
  test("ArithOpParser") {
    testArith("1", Lit(1))
    testArith("4*2", Times(Lit(4),Lit(2)))
    testArith("1+2*3", Plus(Lit(1),Times(Lit(2),Lit(3))))
    testArith("9-4*2", Minus(Lit(9),Times(Lit(4),Lit(2))))
  }
  ...
  test("ArithParOpParser") {
    ...
    testArithPar("-3+4", Plus(Minus(Lit(0),Lit(3)),Lit(4)))
    testArithPar("4*-3", Times(Lit(4),Minus(Lit(0),Lit(3))))
    testArithPar("(1+2)+3", Plus(Plus(Lit(1),Lit(2)), Lit(3)))
    testArithPar("(1+2)*3", Times(Plus(Lit(1),Lit(2)),Lit(3)))
  }
